export const supportedLangs = ['pl', 'en', 'uk'] as const;
...
export const translations: Record<Lang, Translation> = {
  ...
  uk: {
    seoTitle: 'Реєстрація авто Вроцлав',
    seoDescription:
      'Переклад документів та реєстрація імпортованих транспортних засобів у Вроцлаві.',
    hero: {
      heading: 'Реєстрація імпортованого транспортного засобу',
      subtitle: 'Малгожата Саган',
      phone: '605 399 311',
      scrollLabel: 'Прокрутити до розділу послуг'
    },
    servicesTitle: 'Переклад документів та реєстрація транспортних засобів',
    communicationOffices: {
      title: 'Відділи комунікації',
      items: [
        'Реєстрація імпортованих транспортних засобів (автомобілі, мотоцикли, квадроцикли, причепи, сільськогосподарські трактори) та внутрішня перереєстрація',
        'Отримання постійних реєстраційних свідоцтв',
        'Допомога з повідомленням про продаж',
        'Зняття з обліку утилізованих транспортних засобів',
        'Тимчасові експортні реєстраційні номери для транспортних засобів, проданих за кордон'
      ]
    },
    taxOffices: {
      title: 'Податкові органи',
      items: [
        'Акцизні декларації AKC-US',
        'Заяви на звільнення від акцизу для майна при переїзді',
        'Заяви на звільнення від акцизу для вантажних автомобілів',
        'Підтримка компаній — електронне подання декларацій',
        'Довідки, що підтверджують сплату акцизу',
        'Засвідчений переклад документів'
      ]
    },
    deadlines: {
      title: 'Терміни та обов’язки',
      items: [
        'Перереєстрація імпортованого транспортного засобу: 30 днів з моменту ввезення до Польщі',
        'Перереєстрація після купівлі в Польщі: 30 днів з дати купівлі',
        'Подання акцизної декларації: 14 днів з моменту ввезення до Польщі',
        'Подання декларації PCC-3: 14 днів з моменту підписання договору',
        'Подання декларації VAT-23: 14 днів з моменту внутрішньоспільнотного придбання'
      ]
    },
    exciseAccount: {
      title: 'Рахунок для сплати акцизу',
      office: 'Податкова інспекція в Новому Таргу',
      ibanLabel: 'номер рахунку',
      iban: '84 1010 1270 0008 2422 2400 0000'
    },
    about: {
      title: 'Реєстрація авто Вроцлав',
      description:
        'Я працюю в автомобільній галузі вже двадцять років. Протягом чотирнадцяти років допомагаю приватним особам і компаніям з Вроцлава та навколишніх повітів із реєстрацією транспортних засобів і пов’язаними податковими формальностями.',
      company: 'PROMOTO Małgorzata Sagan',
      phone: '605 399 311'
    }
  }
